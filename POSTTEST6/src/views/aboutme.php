...
<head>
    ...
    <link rel="stylesheet" media="screen and (min-width: 600px)" href="../styles/posttest2.css">
    <link rel="stylesheet" media="screen and (max-width: 599px)" href="../styles/mobilep2.css">
    <style>
        body {
...
<body>
    ...
    <footer>
        ...
        <input type="button" id="btn" value="Hide/Show" onclick="hideShow()">
    </footer>

    <script>
        function hideShow() {
            var cpElement = document.getElementById('cp');
            cpElement.style.visibility = cpElement.style.visibility === 'hidden' ? 'visible' : 'hidden';
        }
    </script>
</body>
